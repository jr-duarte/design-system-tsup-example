...
var GridCol = (_a) => {
  ...
  return /* @__PURE__ */ jsx2(styles_default, __spreadProps(__spreadValues({
    col,
    collg: colLg,
    css: css2
  }, props), {
...
function GridRow(_a) {
  ...
  return /* @__PURE__ */ jsx3(styles_default2, __spreadProps(__spreadValues({
    css: css2
  }, props), {
    children
  }));
...
export {
  Amstel_default as Amstel,
  Button,
  ButtonTeste,
  Col_default as GridCol,
  GridRow,
  Heineken_default as Heineken,
  Tiger_default as Tiger,
  config,
  createTheme,
  css,
  getCssText,
